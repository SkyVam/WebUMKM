...
<head>
  ...
  <title>UMKM PADANG | Log in</title>
  <!-- Tell the browser to be responsive to screen width -->
  <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
  <link rel="shorcut icon" type="text/css" href="<?php echo base_url().'assets/img/icon.ico'?>">
  <!-- Bootstrap 3.3.6 -->
  ...
  <style type="text/css">
      body{
        background-image: url('<?php echo base_url('assets/images/gumkm.png')?>');
  ...
  <body class="d-flex align-items-center">
    ...
    <div class="col-md-12 d-xs-none text-center">
          <img src="<?php echo base_url('assets/images/icon.png')?>" width="20%">
        </div>
              ...
              <div class="animate form-login">
                <section class="">
                  <form class="form-horizontal" action="<?php echo site_url().'/admin/register/simpan_pengguna'?>" method="post" enctype="multipart/form-data">
                    <h1 class="text-dark text-center"> Registrasi Akun UMKM PADANG</h1>
