<!-- Masthead-->
        <header class="masthead">
            <div class="container">
            <div class="masthead-subheading">UMKM KOTA PADANG</div>
            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-3">
                        ...
                        <h4 class="my-3">Retail</h4></a>
                        <p class="text-muted"> aktivitas perniagaan yang melibatkan penjualan barang atau penawaran jasa secara langsung</p>
                    </div>
                    <div class="col-md-3">
                        <a href="<?= site_url()?>/home#kategori" class="text-dark js-scroll-trigger">
                        <span class="fa-stack fa-4x">
